...
See [JavaFX 13 and Eclipse](https://answers.sap.com/questions/12960323/javafx-13-and-eclipse.html)

- Download the openjfx SDK from openjfx.io site (for mac was openjfx-18.0.1_osx-x64_bin-sdk.zip as time of writing)
- Move the SDK to your **JavaVirtualMachines** folder (for me; ~/Library/Java/JavaVirtualMachines/javafx-sdk-18.0.1) 
- Add a reference to the SDK path in the Eclipse.ini (right click the Eclipse app > Show Package Contents > Contents > Eclipse > Eclipse.ini- 
